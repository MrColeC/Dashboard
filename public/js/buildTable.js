...
$(function(){
  ...
  var data = [
    ...
    ["Image & Map Generation","Prototype packaging and delivery of ED sub-maps","Andreas","Huanwang Ezra Chenghua","2015-Q3","Web/validation feature","",""],
    ["Image & Map Generation","Prototype pipeline to orient images using symmetry code","Andreas","Peter Chenghua Ezra","2015-Q4","","",""],
    ["Image & Map Generation","Generate new images and maps for entire archive to evaluate pipeline","Andreas","Ezra Chenghua","2016-Q1","Web/validation feature","",""],
    ["Image & Map Generation","Incorporate automatic pipeline for weekly update","Andreas","Vladimir Li Cole","2016-Q2","","",""],
    ["Image & Map Generation","Download option for ED maps","Andreas","Huanwang Ezra Chenghua","2016-Q2","Web/validation feature","",""],
    ["Image & Map Generation","Session files/scripts for image generation","Andreas","Ezra","2016-Q4","","",""],
    ["Image & Map Generation","For ligands similar orientation in gallery similarity search","Andreas","Peter Chenghua","2016-Q4","","",""],
